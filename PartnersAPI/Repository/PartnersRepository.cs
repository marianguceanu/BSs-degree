...
{
	public class PartnersRepository : GenericRepository<Partner>, IPartnerRepository
	{
		...
		{
			return _context.Partners.FirstOrDefaultAsync(p => p.BusinessName == businessName);
		}
	}
}
